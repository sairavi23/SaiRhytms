    ...
    if (localStorage.getItem('Fav') != null) {
        ...
        for (var i in FavJson) {
            if (FavJson[i].Id == id) {
                ...
                document.getElementById("favourite").innerHTML = '<span id="alreadyfav"> This song is a favorite<span/>'
            }
        }
    }
    ...
    function setAudioControl(musiclink)
    {
        if (navigator.onLine){                                                
            ...
            else if(musiclink=="")
            {
                ...
                document.getElementById('nointernet').style.display = "none";
                document.getElementById('noaudio').innerHTML= "No Audio available. If you have the Audio for this Bhajan, Please send an email to <a href='mailto:bhajanapp@gmail.com?subject= Feedback on Bhajan App &body=Jai Sairam'>Bhajan App Email </a>" ;
            }    
